...
public static String _VIEW_APPOINTMENTS= "select p.patient_first_name, p.Patient_Last_Name,a.Appointment_Time from patient p , appointment a where p.Patient_ID=a.Patient_ID and Dentist_ID = ? and Appointment_Date=curdate()";
