...
<div class="Appointment form">
  ...
  <form name="updateappt" action="/siteapp/updappt" method="post" >
    <div class="form-group">
    ...
    <div class="form-group">
         <div class="input-group input-append date" id="dateRangePicker"  style="width:40%">
                <input type="text" value="${Editlist.appointment_Date}" class="form-control" name="appoint_date" >
                <span class="input-group-addon add-on"><span class="glyphicon glyphicon-calendar"></span></span>
            </div>
        </div>
        <div class="form-group" style="width:40%;float:left">
        <select name="hours" class="form-control" id="hours" >
        <option value="" disabled selected>${Editlist.hours}</option>
        <option>10</option>
        <option>11</option>
        <option>12</option>
        <option>13</option>
        ...
        <option value="" disabled selected>${Editlist.mins}</option>
        <option>00</option>
        <option>15</option>
        <option>30</option>
        <option>45</option>
