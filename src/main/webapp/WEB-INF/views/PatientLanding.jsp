...
<div class="row">
    ...
    <div class="col-sm-8"><h4 align="center">Upcoming Appointments jd</h4></div>
  </div>
 ...
 <br>
  ...
  <div class="col-md-1 col-sm-2 col-xs-18">
  &nbsp;  </div>
  <div class="col-md-5 col-sm-3 col-xs-18">
